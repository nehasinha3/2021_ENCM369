...
{
    T0CON0 = 0x90; //timer0 in 16 bit mode with postscaler
    T0CON1 = 0x54; //timer0 set to asynchronous mode with Fosc/4 with a prescaler
...
{
    static u8 u8ArrayIndex = 0; //allows overflow back to 0
